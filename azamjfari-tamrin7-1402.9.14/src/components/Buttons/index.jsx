...
function buttons() {
    return (
        <div className="buttons">
            ...
            <Button look={Button.LOOKS.INFO} variant={Button.VARIANTS.OUTLINED} size={Button.SIZE.MEDIUM} type="submit" disabled={true} >Info</Button>
            ...
            <Button look='' variant='' size=''>Button lg</Button>
            <Button look='' variant='' size=''>Button</Button>
            <Button look='' variant='' size=''>Button sm</Button>
